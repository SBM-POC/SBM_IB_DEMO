...
// ===================================================================
test.describe('[QuickLink] Pay To Mobile', { tag: ['@E2E','@QuickLinksPaytoMobile','@SIA-33'] }, () => {
...
// ===================================================================
test.describe('[QuickLink] Own Account Transfer', { tag: ['@E2E','@QuickLinksOwnAccountTransfer','@SIA-18'] },() => {
...
// ===================================================================
test.describe('[QuickLink] Mobile Top Up',{ tag: ['@E2E','@QuickLinksMobileTopUp','@SIA-60'] }, () => {
