...
export class TransactionHistoryPage {
    ...
    constructor(page: Page) {
        ...
        this.transactionHisOption = page.locator(`xpath=//app-account-nav-bar//a//span[contains(text(),'Transaction History')]`);
        this.accountDetailsOption = page.locator(`xpath=//app-account-nav-bar//a//span[contains(text(),'Account Details')]`);
        this.accountActivityOption = page.locator(`xpath=//app-account-nav-bar//a//span[contains(text(),'Account Activity')]`);
        this.scheduledTransactionsOption = page.locator(`xpath=//app-account-nav-bar//a//span[contains(text(),'Scheduled Transactions')]`);
    ...
    const currentAccountPanel = this.page.locator(`xpath=//app-table-account-item//div[contains(text(),"${accountNum}")]/../preceding-sibling::div[@class='acc-name']//a`);
