...
export class PayToMobilePage {
    ...
    // Temporary stubs to satisfy TypeScript
    async assertAmountGreaterThanBalance(...args: any[]) {}
    async assertRemarksRequired(...args: any[]) {}
    async assertAmountInvalid(...args: any[]) {}
